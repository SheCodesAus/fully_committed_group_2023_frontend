...
function SessionForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        const programResponse = await fetch(`${import.meta.env.VITE_API_URL}programs/${session.program}/`);
                ...
                <div>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <select id="city" name="city" value={session.city} onChange={handleChange}>
                        ...
                        <div>
                            ...
                            <select id="module_type" name="module_type" value={session.module_type} onChange={handleChange}>
